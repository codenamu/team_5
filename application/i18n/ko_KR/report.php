...
$lang = array(
	...
	'country_name' => array(
		'single_country' => '데이터 배치범위는 한 국가안에서만 가능합니다. 현재 데이터 위치를 %s 안으로만 해주세요.',
	) ,
	'data_include' => array(
	...
	'data_active' => array(
		'between' => '데이터 승인대기, 데이터승인, 둘다 중 하나를 선택해주세요.',
		'numeric' => '데이터 승인대기, 데이터승인, 둘다 중 하나를 선택해주세요.',
		'required' => '데이터 승인대기, 데이터승인, 둘다 중 하나를 선택해주세요.',
	) ,
	'data_verified' => array(
		'between' => '데이터 확인대기, 데이터확인, 둘다 중 하나를 선택해주세요.',
		'numeric' => '데이터 확인대기, 데이터확인, 둘다 중 하나를 선택해주세요.',
		'required' => '데이터 확인대기, 데이터확인, 둘다 중 하나를 선택해주세요.',
	) ,
	'data_point' => array(
		'between' => '다운로드할 정확한 타입의 데이터를 선택하세요.',
		'numeric' => '다운로드할 정확한 타입의 데이터를 선택하세요.',
		'required' => '다운로드할 정확한 타입의 데이터를 선택하세요.',
	) ,
	'from_date' => array(
	...
	'incident_active' => array(
		'between' => '이 데이터 승인을 위해 정확한 값을 입력하세요.',
		'required' => '이 데이터 승인을 위해 정확한 값을 입력하세요.',
	) ,
	'incident_ampm' => array(
	...
	'incident_title' => array(
		...
		'required' => '제목을 입력해주세요.',
		'csrf' => 'CSRF 공격에 노출될 수 있습니다. 데이터를 만들거나 수정하시겠습니까?
참조 : CSRF 설명 http://goo.gl/gFULR',
	) ,
	'incident_verified' => array(
		'between' => '이 데이터 확인을 위해 정확한 값을 입력해주세요.',
		'required' => '이 데이터 확인을 위해 정확한 값을 입력해주세요.',
	) ,
	...
	'locale' => array(
		...
		'exists' => '이 데이터는 이미 해당 언어로 번역되었습니다.',
		'length' => '로컬 필드 값이 잘못되었습니다.',
		'locale' => '원본 데이터와 번역본이 동일한 로컬(언어)입니다.',
