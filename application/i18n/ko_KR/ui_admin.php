...
$lang = array(
	...
	'new_password' => '새비밀번호',
	'no' => '아니오',
	'none_category_explanation' => '스페셜카테고리는 유저의 데이터 공유 폼에서는 보이지 않습니다. 여기에는 카테고리가 삭제되어 카테고리가 지정되지 않은 데이터의 카테고리로 사용됩니다.',
	'notification' => '공지',
	...
	'select_download_format' => '데이터 다운로드 포맷 선택:-',
	...
	'yes' => '네',
	'your_search_for' => '검색어 ',
	'delete_all_instructions' => '아래의 버튼을 클릭하면 모든 데이터가 데이터베이스에서 삭제됩니다. 삭제 이후에는 되돌릴 수 없습니다.',
	'delete_all_backup' => '진행 전에 데이터베이스를 백업하는 것을 추천합니다.',
	'delete_all_button' => '데이터베이스의 데이터 중 %s 를 삭제하기를 원합니다.',
	'delete_all_confirm' => '데이터를 전부 삭제하기를 원하나요?',
	'delete_all_no_reports' => '지울 데이터가 없습니다.',
